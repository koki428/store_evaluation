                ...
                <div class="row g-5 align-items-center">
                    <div class="col-Auto">
                        <div class="position-relative mx-auto">
                            <p>このページは店名で検索できます</p>
                            <form action="/stores/name_index/search_result" method="GET">
                                @csrf
                                <input class="form-control border-2 border-secondary w-75 py-3 px-4 rounded-pill" type="text" name="name" placeholder="店名で検索">
